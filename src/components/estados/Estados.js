...
export default function Estados() {
	...
	const editarEstado = async (e) => {
		...
		try {
			setError(false);
			const resp = await editarEstadoPorID(
				estado.idestado_equipo,
				estado
			);
			console.log(resp);
			resetEstado();
	...
	const setEstadoPorId = (e) => {
		...
		const estadosFilter = estados.filter(
			(t) => t.idestado_equipo == e.target.id
		);
		...
		<div>
			...
			{/* <div className='form-check form-switch'>
				...
				<label
					...
					hmtlFor='flexSwitchCheckChecked'
				>
					( Inactivo / Activo )
				</label>
			</div> */}
